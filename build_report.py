...
<section>
  ...
  <p>
    Per-second NOTPM for the BP 50G, 64 VU run from each engine.
...
<section>
  ...
  <p>
    Each box shows the distribution of per-second NOTPM samples during the final 30 minutes of a run.
